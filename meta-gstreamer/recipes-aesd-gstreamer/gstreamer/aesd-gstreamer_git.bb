...
#SRC_URI = "git://git@github.com/cu-ecen-aeld/assignments-3-and-later-ajsanthosh14.git;protocol=ssh;branch=master"
SRC_URI = "git://git@github.com/cu-ecen-aeld/final-project-ajsanthosh14.git;protocol=ssh;branch=main"

PV = "1.0+git${SRCPV}"
# TODO: set to reference a specific commit hash in your assignment repo
#SRCREV = "65012a7172c5c4a51aebd2357e8e07ca36fb8e7a"
SRCREV = "87038347939ed6031be12b63691fe792866dd684"
